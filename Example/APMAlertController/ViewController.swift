...
class ViewController: UIViewController {
    ...
    func alertTextTitleAttributedMessage(_ indexPath: IndexPath) {
        ...
        attributedMessage.addAttributes([
            ...
            NSAttributedString.Key.foregroundColor: UIColor(red: 0.581, green: 0.129, blue: 0.575, alpha: 1.0)
        ],
            range: NSRange(location: 0, length: 28)
        )
        attributedMessage.addAttributes([
            NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 14),
            NSAttributedString.Key.foregroundColor: UIColor(red: 0.276, green: 0.32, blue: 0.6, alpha: 1.0)
        ],
            range: NSRange(location: 28, length: 29)
        )
        attributedMessage.addAttributes([
            NSAttributedString.Key.font: UIFont.italicSystemFont(ofSize: 16),
            NSAttributedString.Key.foregroundColor: UIColor(red: 0.488, green: 0.593, blue: 0.424, alpha: 1.0)
        ],
            range: NSRange(location: 57, length: 22)
        )
        attributedMessage.addAttributes([
            NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 10),
            NSAttributedString.Key.foregroundColor: UIColor(red: 0.0, green: 0.656, blue: 0.571, alpha: 1.0)
        ],
